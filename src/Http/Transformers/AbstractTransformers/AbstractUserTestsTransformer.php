...
class AbstractUserTestsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(UserTests $model)
    {
    ...
    public function includeActions(UserTests $model)
    {
    ...
    public function includeMedia(UserTests $model)
    {
    ...
    public function includeSocialMedia(UserTests $model)
    {
    ...
    public function includeComments(UserTests $model)
    {
    ...
    public function includeVotes(UserTests $model)
    {
    ...
    public function includeMeta(UserTests $model)
    {
    ...
    public function includePhoneNumbers(UserTests $model)
    {
    ...
    public function includeAddresses(UserTests $model)
    {
