...
class AbstractAnswersTransformer extends AbstractTransformer
{
    ...
    public function includeStates(Answers $model)
    {
    ...
    public function includeActions(Answers $model)
    {
    ...
    public function includeMedia(Answers $model)
    {
    ...
    public function includeSocialMedia(Answers $model)
    {
    ...
    public function includeComments(Answers $model)
    {
    ...
    public function includeVotes(Answers $model)
    {
    ...
    public function includeMeta(Answers $model)
    {
    ...
    public function includePhoneNumbers(Answers $model)
    {
    ...
    public function includeAddresses(Answers $model)
    {
