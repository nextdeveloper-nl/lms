...
class AbstractQuestionsTransformer extends AbstractTransformer
{
    ...
    public function includeStates(Questions $model)
    {
    ...
    public function includeActions(Questions $model)
    {
    ...
    public function includeMedia(Questions $model)
    {
    ...
    public function includeSocialMedia(Questions $model)
    {
    ...
    public function includeComments(Questions $model)
    {
    ...
    public function includeVotes(Questions $model)
    {
    ...
    public function includeMeta(Questions $model)
    {
    ...
    public function includePhoneNumbers(Questions $model)
    {
    ...
    public function includeAddresses(Questions $model)
    {
