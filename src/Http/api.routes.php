    ...
    function () {
        Route::prefix('courses')->group(
            function () {
                ...
                Route::post('/{lms_courses}/do/{action}', 'Courses\CoursesController@doAction');
        ...
        Route::prefix('homework')->group(
            function () {
                ...
                Route::get('/actions', 'Homework\HomeworkController@getActions');
                ...
                Route::post('/{lms_homework}/do/{action}', 'Homework\HomeworkController@doAction');
        ...
        Route::prefix('homework-answers')->group(
            function () {
                ...
                Route::get('/actions', 'HomeworkAnswers\HomeworkAnswersController@getActions');
                ...
                Route::post('/{lms_homework_answers}/do/{action}', 'HomeworkAnswers\HomeworkAnswersController@doAction');
        ...
        Route::prefix('tests')->group(
            function () {
                ...
                Route::post('/{lms_tests}/do/{action}', 'Tests\TestsController@doAction');
        ...
        Route::prefix('questions')->group(
            function () {
                ...
                Route::get('/actions', 'Questions\QuestionsController@getActions');
                ...
                Route::post('/{lms_questions}/do/{action}', 'Questions\QuestionsController@doAction');
        ...
        Route::prefix('answers')->group(
            function () {
                ...
                Route::get('/actions', 'Answers\AnswersController@getActions');
                ...
                Route::post('/{lms_answers}/do/{action}', 'Answers\AnswersController@doAction');
        ...
        Route::prefix('user-tests')->group(
            function () {
                ...
                Route::get('/actions', 'UserTests\UserTestsController@getActions');
                ...
                Route::post('/{lms_user_tests}/do/{action}', 'UserTests\UserTestsController@doAction');
