...
/**
 * Class LMSServiceProvider
 *
 * @package NextDeveloper\LMS
 */
class LMSServiceProvider extends AbstractServiceProvider
{
    /**
     * @var bool
     */
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom($this->dir.'/../resources/views', 'LMS');
    ...
    protected function registerRoutes()
    {
        if (! $this->app->routesAreCached()) {
            $this->app['router']
                ->namespace('NextDeveloper\LMS\Http\Controllers')
