...
class AbstractCoursesService
{
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\LMS\Courses', $model);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updated:NextDeveloper\LMS\Courses', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\LMS\Courses', $model);
