...
class AbstractHomeworkAnswersService
{
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\LMS\HomeworkAnswers', $model);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updating:NextDeveloper\LMS\HomeworkAnswers', $model);
        ...
        Events::fire('updated:NextDeveloper\LMS\HomeworkAnswers', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\LMS\HomeworkAnswers', $model);
