...
class AbstractAnswersService
{
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\LMS\Answers', $model);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updating:NextDeveloper\LMS\Answers', $model);
        ...
        Events::fire('updated:NextDeveloper\LMS\Answers', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\LMS\Answers', $model);
