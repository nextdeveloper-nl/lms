...
class AbstractHomeworkService
{
    ...
    public static function create(array $data)
    {
        ...
        Events::fire('created:NextDeveloper\LMS\Homework', $model);
    ...
    public static function update($id, array $data)
    {
        ...
        Events::fire('updating:NextDeveloper\LMS\Homework', $model);
        ...
        Events::fire('updated:NextDeveloper\LMS\Homework', $model);
    ...
    public static function delete($id)
    {
        ...
        Events::fire('deleted:NextDeveloper\LMS\Homework', $model);
