...
use NextDeveloper\LMS\Database\Observers\HomeworkAnswersObserver;
...
class HomeworkAnswers extends Model
{
    ...
    protected $table = 'lms_homework_answers';
    ...
    public static function boot()
    {
        ...
        parent::observe(HomeworkAnswersObserver::class);
    ...
    public static function registerScopes()
    {
        ...
        $modelScopes = config('lms.scopes.lms_homework_answers');
